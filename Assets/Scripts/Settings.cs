public static class Settings
{
    ...
    public const float NpcDefaultMovementSpeed = 4f; // 0.7f
    ...
    public const string ConstEditStoreMenuRotateLeft = "RotateLeft";
    public const string ConstEditStoreMenuRotateRight = "RotateRight";
