...
public static class MenuObjectList
{
    ...
    public static void SetAllItems()
    {
        ...
        AllStoreItems = new List<StoreGameObject>{
            new StoreGameObject("Wooden table", "SingleTable-1", ObjectType.NPC_SINGLE_TABLE, StoreItemType.TABLE_SINGLE_1, Settings.SpriteLibCategoryTables, Settings.PrefabSingleTable, 20, true),
            new StoreGameObject("Wooden squared table", "SingleTable-2", ObjectType.NPC_SINGLE_TABLE, StoreItemType.TABLE_SINGLE_2, Settings.SpriteLibCategoryTables, Settings.PrefabSingleTable, 40, true),
            ...
            new StoreGameObject("Counter", "Counter-1", ObjectType.NPC_COUNTER, StoreItemType.COUNTER_1, Settings.SpriteLibCategoryStoreObjects, Settings.PrefabCounter, 50, true),

            new StoreGameObject("Wooden container", "Dispenser-1", ObjectType.STORE_ITEM, StoreItemType.SNACK_MACHINE_1, Settings.SpriteLibCategoryStoreItems, Settings.PrefabSnackMachine, 40, false),
    ...
    public static string GetItemSprite(ItemType type)
    {
        switch (type)
        {
            case ItemType.ORANGE_JUICE: return "Dispenser-1";
        }
        return "";
    }
    ...
    public static string GetPrefab(StoreItemType type)
    {
        ...
        switch (obj.StoreItemType)
        {
            ...
            case StoreItemType.COUNTER_1: return Settings.PrefabCounter;
            case StoreItemType.SNACK_MACHINE_1: return Settings.PrefabSnackMachine;
        }
        return "";
    }
    ...
    public static List<StoreGameObject> GetItemList(MenuTab tab)
    {
        switch (tab)
        {
            case MenuTab.STORE_ITEMS: return ActionPointItems;
            case MenuTab.STORAGE_TAB: return BaseDispenserList;
    ...
    public static string GetButtonLabel(MenuTab tab)
    {
        switch (tab)
        {
            ...
            case MenuTab.SNACKS_TAB: return "Dispensers";
