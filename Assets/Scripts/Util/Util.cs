...
public static class Util
{
    ...
    {
        return Vector3.Distance(new Vector3(a.x, a.y, 0), new Vector3(b.x, b.y, 0)) <= 0.03f;// Needs less precision for diagonal movement
    }
    ...
    // Use camere Culling inside the animation instead
